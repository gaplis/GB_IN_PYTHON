...
# print(f'{p1.__max_up = }') # AttributeError: 'Person' object has no attribute '__max_up'
# print(f'{Person.__max_up = }') # AttributeError: 'Person' object has no attribute '__max_up'
